...
const Personal: NextPage = () => {
    const info = {
        ...
        gender: 'male',
        address: ['23 sta. fe street blk-3 brgy. 103 zone-8 magsaysay village District 1 Tondo, Manila Philippines', 'no. 34 Cabana CWC Brgy. Cadlan Camarines Sur Capitol, Bicol Philippines'],
        mobile: '09761740995',
        nick: 'Ed',
        email: 'cabrerajohnedward@gmail.com',
                ...
                <div className="md:flex grid grid-cols-1 w-max mx-auto">
                    ...
                    <div className="flex-grow p-3 my-auto">
                        ...
                        <div className="grid grid-cols-3 gap-5">
                            <p className={info.style[0]}>{info.position[0]}</p>
                            <p className={info.style[0]}>{info.position[1]}</p>
                            <p className={info.style[0]}>{info.position[2]}</p>
                        </div>
                    </div>
                </div>
                <div className="my-10 bg-gray-300 bg-opacity-25 p-5">
                    <ul className='md:w-2/3 w-10/12 mx-auto rounded p-3 text-left'>
                        <li className={info.style[1]}>
