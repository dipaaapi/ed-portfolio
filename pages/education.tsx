...
const education = () => {
    const info = {
        ...
        status: ['elementary school', 'high school', 'computer literacy basic and advance', 'CHS or CSS / Comp. Tech.', 'bachelor of science in information tecnology (bsit)'],
        ...
        <div className={styles.container}>
            ...
            <main>
                ...
                <div className="w-full bg-lime-500">
                    ...
                    <div className="w-max mx-auto flex p-5 space-x-5">
                        <div className="my-auto">
                            <p className="text-3xl text-right font-bold text-white uppercase">{info.title[2]}</p>
                            <p className="text-2xl text-right font-bold text-white uppercase">{info.graduate[2]}</p>
                        </div>
                        <img src="/iscom.png" alt="iscom" className="w-[10vw] hover:animate-ping" />
                        <div className="my-auto">
                            <p className="text-3xl text-left font-bold text-white uppercase">{info.status[2]}</p>
                            <p className="text-2xl text-left font-bold text-white uppercase">{info.level[2]}</p>
                        </div>
                    </div>
                    <div className="w-max mx-auto flex p-5 space-x-5">
                        <div className="my-auto">
                            <p className="text-3xl text-right font-bold text-white uppercase">{info.title[3]}</p>
                            <p className="text-2xl text-right font-bold text-white uppercase">{info.graduate[3]}</p>
                        </div>
                        <img src="/tesda.png" alt="tesda" className="w-[10vw] hover:animate-ping" />
                        <div className="my-auto">
                            <p className="text-3xl text-left font-bold text-white uppercase">{info.status[3]}</p>
                            <p className="text-2xl text-left font-bold text-white uppercase">{info.level[3]}</p>
                        </div>
                    </div>
                </div>
